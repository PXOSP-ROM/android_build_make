...
include vendor/pxosp/config/BoardConfigLineage.mk
...
ifneq ($(wildcard device/pxosp/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/pxosp/sepolicy/common/sepolicy.mk)
endif
